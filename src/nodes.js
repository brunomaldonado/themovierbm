...
const mostPopularPreviewLeft = document.getElementById('mostPopularPreview_left')
...
const scrollerContent = document.querySelector('.scroller_content');
const rowFlex = document.querySelector('.row_flex');
const favouriteRowContainer = document.querySelector('.favourite_row__container');
const mostPopularPreviewContainer = document.querySelector('.mostPopularPreview_container')
