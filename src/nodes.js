/* SECTION */
const bannerSliceSection = document.getElementById('bannerSlice')
...
const releaseDate_inside = document.querySelector('#release_date_inside')
const productionCountries_inside = document.querySelector('#production_countries_inside');
const typeLanguages = document.querySelector('.typeLanguage');
const typeLanguages_inside = document.querySelector('.typeLanguages_inside');
const categoryType_inside = document.querySelector('.categoryType_inside')
const detailOverview_inside = document.querySelector('.detailOverview_inside');
